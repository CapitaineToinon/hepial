...
public class MoinsTest extends SemantiqueTest {
    private final Path TESTS_FOLDER = Utils.resources.resolve("ast/expression/unaire/moins");

    @Test
    public void moins_ok() throws Exception {
    ...
    @Test
    public void moins_type_check_1() throws Exception {
