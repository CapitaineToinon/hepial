...
public class EgalTest extends SemantiqueTest {
    private final Path TESTS_FOLDER = Utils.resources.resolve("ast/expression/binaire/relation/egal");

    @Test
    public void egal_ok() throws Exception {
    ...
    @Test
    public void egal_type_check_1() throws Exception {
    ...
    @Test
    public void egal_type_check_2() throws Exception {
