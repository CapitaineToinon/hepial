...
public class EtTest extends SemantiqueTest {
    private final Path TESTS_FOLDER = Utils.resources.resolve("ast/expression/binaire/relation/et");

    @Test
    public void et_ok() throws Exception {
    ...
    @Test
    public void et_type_check_1() throws Exception {
    ...
    @Test
    public void et_type_check_2() throws Exception {
