...
public class DiffTest extends SemantiqueTest {
    private final Path TESTS_FOLDER = Utils.resources.resolve("ast/expression/binaire/relation/diff");

    @Test
    public void diff_ok() throws Exception {
    ...
    @Test
    public void diff_type_check_1() throws Exception {
    ...
    @Test
    public void diff_type_check_2() throws Exception {
