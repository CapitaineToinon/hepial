...
public class InferieurTest extends SemantiqueTest {
    private final Path TESTS_FOLDER = Utils.resources.resolve("ast/expression/binaire/relation/inferieur");

    @Test
    public void inferieur_ok() throws Exception {
    ...
    @Test
    public void inferieur_type_check_1() throws Exception {
    ...
    @Test
    public void inferieur_type_check_2() throws Exception {
